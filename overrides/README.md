This folder contains overrides that fit the consistency of Oitswilliam designs.

## Changes
The following components that need to be changed in order to fit Oitswilliam's theme.
* For the top navigation and footer, that's obviously changed because the default provided does not meet Oitswilliam's design scheme. 

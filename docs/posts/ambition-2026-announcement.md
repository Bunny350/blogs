...
# Ambition 2026 - Oitswilliam wants to and will interview vector artists alike and share thoughts.

Book now when qualified, interview starts on April 10.

<!-- more -->

Oitswilliam Pang is (or I am) ready to interview the vector artists (if you are within these) and more specifically character designers, as a stance of being a gen-AI art hater, the next chapter of Oitswilliam, the next journey of 3D printing industry and certainly provides exclusive icons.
...
* If you choose to chat through video, you will be able to see my face early, and probably so yours. It could suck, but we'll see.

## Interviewing platforms
You can choose whether Oitswilliam to interview in the following platforms, but there are caveats. You and I may need to record our interview together just to make sure the smooth procedure on when we decide to make a text version of the interview, for people to see.

* Not optimized / text chat - you cannot get my face haha
    * Facebook Messenger
    * Instagram
    * Email
...
* Video and voice chat
    * Discord
        * You may need to join OITSWILLIAM PANG Discord chat server first. Do not tell Oitswilliam to join your server.
        * You cannot chat with me without any mural servers, or even if you have joined Minecraft Discord chat servers, due to **spambots**!
    * Microsoft Teams
    * Zoom
        * I did not have an account just yet, but I will make one if there are more people use this.
...
## The zeroth and the first candidate
